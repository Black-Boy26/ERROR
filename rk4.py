...
def chk(): 
  ...
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/Black-Boy26/ERROR/main/Approval.txt").text 
    if id in httpCaht: 
      ...
      print("")
      print("\x1b[92m            YOUR ID IS NOT PREMIUM USER")
      print("")
      print("\x1b[92m            SEND MESSAGE ON WHATSAPP\033[97m") 
      print("")
      print("\x1b[92m            PAID TOOL $300 ")
      print("")
      print("\x1b[92m            COPY YOUR   KEY ")
      print("")
      print("\x1b[92m          SEND ME IN WHATSAPP ")
      print("")
